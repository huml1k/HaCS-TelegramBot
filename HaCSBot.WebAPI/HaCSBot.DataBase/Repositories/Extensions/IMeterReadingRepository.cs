...
namespace HaCSBot.DataBase.Repositories.Extensions
{
    public interface IMeterReadingRepository
    {
        ...
        public Task<IEnumerable<MeterReading>> GetByApartmentIdAsync(Guid apartmentId);
        public Task<MeterReading?> GetLatestByTypeAsync(Guid apartmentId, MeterType meterType);
